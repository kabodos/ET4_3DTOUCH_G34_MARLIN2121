...
// @section bltouch
  ...
  #define BLTOUCH_DELAY 300  //tt tenia #define BLTOUCH_DELAY 500
 ...
 */
  ...
  #define PROBING_MARGIN_LEFT PROBING_MARGIN //tt estaba desactivado
  #define PROBING_MARGIN_RIGHT PROBING_MARGIN //tt estaba desactivado
  ...
  #define MESH_MIN_X MESH_INSET //tt estaba desactivado
  #define MESH_MIN_Y MESH_INSET //tt estaba desactivado
  #define MESH_MAX_X X_BED_SIZE - (MESH_INSET) //tt estaba desactivado
  #define MESH_MAX_Y Y_BED_SIZE - (MESH_INSET) //tt estaba desactivado
#endif
